 ...
 * <ul>
 *     <li>
 *         <a href="https://docs.github.com/en/rest/commits/commits#list-pull-requests-associated-with-a-commith">
 *             List pull requests associated with a commit</a>
 *     </li>
 *     <li>
 *         <a href="https://docs.github.com/en/rest/pulls/pulls#list-pull-requests">
 ...
 *     </li>
 *     <li>
 *         <a href="https://docs.github.com/en/rest/pulls/pulls#get-a-pull-request">
...
public class PullRequest extends GitHubOperation {
    ...
    /**
     * {@code PullRequestSort} list of available pull request sorters
     **/
    public enum PullRequestSort {

        /**
         * {@code created} pull request sort
         **/
        created("created"),

        /**
         * {@code updated} pull request sort
         **/
        updated("updated"),

        /**
         * {@code popularity} pull request sort
         **/
        popularity("popularity"),

        /**
         * {@code long_running} pull request sort
         **/
        ...
        /**
         * Constructor to init {@link PullRequestSort}
         *
         * @param sort: sort value
         **/
        PullRequestSort(String sort) {
            this.sort = sort;
        }
     ...
     *
     * @param pullRequestResponse: obtained from GitHub's response
     * @param format:              return type formatter -> {@link ReturnFormat}
     * @return pull request as {@code "format"} defines
     **/
    @Returner
    public static <T> T returnPullRequest(String pullRequestResponse, ReturnFormat format) {
        switch (format) {
            case JSON:
                return (T) new JSONObject(pullRequestResponse);
            case LIBRARY_OBJECT:
                return (T) new PullRequest(new JSONObject(pullRequestResponse));
            default:
                return (T) pullRequestResponse;
        }
    }
     ...
     **/
    @Returner
    public static <T> T returnPullRequestsList(String pullRequestsListResponse, ReturnFormat format) {
        switch (format) {
            case JSON:
